    ...
    <div class="mb-8 flex items-end justify-between">
        <div>
            ...
            <h2 class="text-3xl font-manrope font-extrabold tracking-tight text-blue-900">
                Satuan <span class="text-primary italic">Barang</span>
            </h2>
        </div>
        ...
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-100/50">
                ...
                <tr class="hover:bg-blue-50/30 transition-colors">
                    ...
                    <td class="px-8 py-4 font-manrope font-bold text-blue-900 text-sm">{{ $unit->name }}</td>
                    <td class="px-8 py-4">
                ...
                <tr>
                    <td colspan="4" class="px-8 py-16 text-center">
                        <span class="material-symbols-outlined text-slate-200 text-5xl block mb-3">straighten</span>
                        <p class="text-slate-400 text-sm">Belum ada satuan.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
        </table>
        <div class="px-8 py-4 bg-surface-container-low/30 border-t border-slate-100/50">
            <span class="text-xs text-slate-400">{{ $units->count() }} satuan</span>
        </div>
    </div>
</x-app-layout>
